...
const CardVip3 = () => {
    return (
        <StyledWrapper>
            <div className="main">
                <div className="card">
                    <div className="heading">Plano SUPERFAN</div>
                    <div className="details"><b>Assista em até 4 TELAS</b><br />Novos episódios após o <br />lançamento no Japão <br />Offline Viewing</div>
                    <div className="price">R$199,99/ano</div>
...
;
  ...
  .card:hover .heading {
    transform: translateY(7em) translateX(1.0em);
  }

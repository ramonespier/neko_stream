...
const CardVip2 = () => {
  return (
    <StyledWrapper>
      <div className="main">
        <div className="card">
          <div className="heading">Plano MEGAFAN</div>
          <div className="details"><b>Assista em até 4 TELAS</b><br />Novos episódios após o <br />lançamento no Japão <br/>Offline Viewing<br/></div>
          <div className="price">R$18,99/mês</div>
...
;
  ...
  .card:hover .heading {
    transform: translateY(7em) translateX(1.3em);
  }

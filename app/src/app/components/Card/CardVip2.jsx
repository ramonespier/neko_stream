    ...
    <>
      ...
      <div className="card w-85 lg:w-[400] bg-rose-900 text-white p-8 rounded-xl border-2 mt-8">
        <div className="list flex flex-col items-center gap-5">
          <div className="titulo font-extrabold text-3xl"><h2>MEGAFAN</h2></div>
          <div className="price text-3xl font-extrabold">R$ 19,99/mês</div>
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[13px]">✔ Acesse a Neko Game Vault, um catálogo de jogos gratuitos
            </span>
          </div>
        </div>
      </div>
